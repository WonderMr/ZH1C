Функция ПолучитьСвойство(НазваниеРеквизита, ПринадлежностьНабора)
    Попытка
        Запрос                                          =   Новый Запрос("
                                                                            ...
                                                                            |   И НабДР.Ссылка.Наименование Подобно ""%"" + &НазваниеДокумента
                                                                            |");
...
Процедура СохранитьДопРеквизит(МойОбъект, ИмяРеквизита, ЗначениеРеквизита) Экспорт
    Попытка
        ...
        Тогда
            СвойствоРеквизита                           =   ПолучитьСвойство(ИмяРеквизита, МойОбъект.Метаданные().Синоним);
...
Функция ПолучитьСвойствоРеквизита(МоёИмя, МойОбъект) Экспорт
    МойТипРеквизита                                     =   ПолучитьСвойство(МоёИмя, МойОбъект.Метаданные().Синоним);
    Если
