Функция ПолучитьСвойство(НазваниеРеквизита, ПринадлежностьНабора, ТипНабора)
    Попытка
        ...
        Запрос.УстановитьПараметр("ПолноеНазваниеДокумента" , ТипНабора + " " + ПринадлежностьНабора);
    ...
    Попытка
        ...
        Тогда
            ...
            Тогда
                 ...
                 МойТипЗначения.Владелец                =   СвойствоРеквизита;
...
Функция ПолучитьСписокЗначенийДопРеквизита(ЗначениеОбъекта, НазваниеРеквизита) Экспорт
    ...
    Синоним                                             =   ЗначениеОбъекта.Метаданные().Синоним;
    ...
    Запрос.УстановитьПараметр("СвойствоРеквизита"       , ПолучитьСвойство(НазваниеРеквизита, Синоним, ТипОбъекта));
    Результат                                           =   Запрос.Выполнить().Выбрать();
    Ответ                                               =   Новый Массив;
    Пока
        Результат.Следующий()
...
Функция ПолучитьСвойствоРеквизита(МоёИмя, МойОбъект) Экспорт
    ...
    Синоним                                             =   МойОбъект.Метаданные().Синоним;
    ТипОбъекта                                          =   Лев(ПолноеИмя, СтрНайти(ПолноеИмя, ".") - 1);
    МойТипРеквизита                                     =   ПолучитьСвойство(МоёИмя, Синоним, ПолноеИмя);
    Если
