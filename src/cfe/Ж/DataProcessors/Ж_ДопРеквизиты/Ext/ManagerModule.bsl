...
Процедура СохранитьДопРеквизит(МойОбъект, ИмяРеквизита, ЗначениеРеквизита) Экспорт
    Попытка
        ...
        Тогда
            //Проверяем наличие по наименованию и по полному наименованию
            ...
            Тогда
                ЭтоЗначение                             =   Справочники.ЗначенияСвойствОбъектов.СоздатьЭлемент();
                ЭтоЗначение.Наименование                =   ЗначениеРеквизита;
                ЭтоЗначение.ПолноеНаименование          =   ЗначениеРеквизита;
                ЭтоЗначение.Владелец                    =   СвойствоРеквизита;
                ЭтоЗначение.Записать();
                МойРеквизит.Значение                    =   ЭтоЗначение.Ссылка;
            Иначе
                МойРеквизит.Значение                    =   МойТипЗначенияН;
            КонецЕсли;
        Иначе
            МойРеквизит.Значение                        =   ЗначениеРеквизита;
        КонецЕсли;
